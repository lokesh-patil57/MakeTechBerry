          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-4 text-base text-black dark:text-gray-300 lg:mt-8 sm:text-xl transition-colors duration-300">
                MakeTechBerry LLP, based in Pune, empowers learners and
                startups with hands-on training, real tech projects, and
                expert mentorship in Android, Web, AI/ML, and full-stack
                development.
              </p>
